...
export class Migration20260922040710_add_event_feed extends Migration {
  ...
  override up(): void | Promise<void> {
    this.addSql(`create table "posts"."transport_event_feed" ("position" bigserial primary key, "identifier" varchar(255) not null, "message_type" varchar(255) not null, "payload" text not null, "appended_at" timestamptz not null);`);
