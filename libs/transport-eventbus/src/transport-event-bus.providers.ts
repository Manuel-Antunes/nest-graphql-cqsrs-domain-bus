...
import { MemoryAddressing } from './outbound/addressing/memory.addressing';
import { RabbitMqAddressing } from './outbound/addressing/rabbitmq.addressing';
 ...
 * have to have one.
 *
 * `DiscoveryModule` is Nest's own, and it is what finds the `@Publisher` and `@Addressing` classes
