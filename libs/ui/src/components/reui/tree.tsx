...
function TreeItemLabel<T = any>({
  ...
  return (
    <span
      ...
      className={cn(
        'flex items-center gap-1 bg-background in-data-[drag-target=true]:bg-accent in-data-[search-match=true]:bg-primary/10! in-data-[selected=true]:bg-accent not-in-data-[folder=true]:ps-7 in-data-[selected=true]:text-accent-foreground in-focus-visible:ring-[3px] in-focus-visible:ring-ring/50 transition-colors hover:bg-accent [&_svg]:pointer-events-none [&_svg]:shrink-0',
        'rounded-md',
        'py-1.5',
        'px-2',
        'text-sm',
